...
import (
	...
	"github.com/lerity-yao/go-zero/tools/cztctl/rpc/generator"
...
func RPCTemplate(latest bool) error {
	if !latest {
		console.Warning("deprecated: cztctl rpc template -o is deprecated and will be removed in the future, use cztctl rpc -o instead")
	}
