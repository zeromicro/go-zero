...
import (
	...
	sortedmap "github.com/lerity-yao/go-zero/tools/cztctl/pkg/collection"
...
// init initializes the cztctl environment variables, the environment variables of the function are set in order,
