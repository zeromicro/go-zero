...
# local compare test
# compare cztctl between latest and newest version if exists different.
...
echo "=======================install goctl============================="
# install latest cztctl
execute_command "go install github.com/lerity-yao/go-zero/tools/cztctl@master"
