...
import (
	...
	"github.com/lerity-yao/go-zero/tools/cztctl/api/parser/g4/ast"
	...
	apiParser "github.com/lerity-yao/go-zero/tools/cztctl/pkg/parser/api/parser"
)
...
// Depreacted: use tools/cztctl/pkg/parser/api/parser/parser.go:18 instead,
