...
const BuildVersion = "1.9.2.1-alpha"
...
// IsVersionGreaterThan compares whether the current cztctl version
...
func IsVersionGreaterThan(version, target string) bool {
	...
	if versionNumber > targetVersionNumber {
		...
		// unchecked case, in normal, the cztctl version does not contain suffix in release.
