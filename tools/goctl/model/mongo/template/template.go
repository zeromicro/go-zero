...
import (
    ...
    "github.com/globalsign/mgo/bson"
     {{if .Cache}}cachec "github.com/z-micro/go-zero/core/stores/cache"
	"github.com/z-micro/go-zero/core/stores/mongoc"{{else}}"github.com/z-micro/go-zero/core/stores/mongo"{{end}}
)
