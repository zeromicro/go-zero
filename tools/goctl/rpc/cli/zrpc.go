...
var (
	...
	errMutilInput        = errors.New("ZRPC: only one source is expected")
)
...
// ZRPC forks a new process named protoc and exec,
// zrpc code generated by protoc-gen-zrpc plugin to protoc,
