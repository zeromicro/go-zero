...
func init() {
	...
	newCmdFlags.StringVarPWithDefaultValue(&cli.VarStringGoZeroVersion, "go_zero_version", "z", config.GoZeroVersion)
	newCmdFlags.StringVarPWithDefaultValue(&cli.VarStringToolVersion, "tool_version", "t", config.ToolVersion)
