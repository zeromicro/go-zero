...
func init() {
	...
	newCmdFlags.StringVarPWithDefaultValue(&new.VarStringGoZeroVersion, "go_zero_version", "z", config.GoZeroVersion)
	newCmdFlags.StringVarPWithDefaultValue(&new.VarStringToolVersion, "tool_version", "t", config.ToolVersion)
