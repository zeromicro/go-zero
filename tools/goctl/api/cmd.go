...
import (
	...
	"github.com/dropship-dev/go-zero/tools/goctl/api/apigen"
	"github.com/dropship-dev/go-zero/tools/goctl/api/dartgen"
	"github.com/dropship-dev/go-zero/tools/goctl/api/docgen"
	"github.com/dropship-dev/go-zero/tools/goctl/api/format"
	"github.com/dropship-dev/go-zero/tools/goctl/api/gogen"
	"github.com/dropship-dev/go-zero/tools/goctl/api/javagen"
	"github.com/dropship-dev/go-zero/tools/goctl/api/ktgen"
	"github.com/dropship-dev/go-zero/tools/goctl/api/new"
	"github.com/dropship-dev/go-zero/tools/goctl/api/swagger"
	"github.com/dropship-dev/go-zero/tools/goctl/api/tsgen"
	"github.com/dropship-dev/go-zero/tools/goctl/api/validate"
	"github.com/dropship-dev/go-zero/tools/goctl/config"
	"github.com/dropship-dev/go-zero/tools/goctl/internal/cobrax"
	"github.com/dropship-dev/go-zero/tools/goctl/plugin"
)
