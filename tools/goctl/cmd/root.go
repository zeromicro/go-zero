...
import (
	...
	"github.com/dropship-dev/go-zero/tools/goctl/api"
	"github.com/dropship-dev/go-zero/tools/goctl/bug"
	"github.com/dropship-dev/go-zero/tools/goctl/config"
	"github.com/dropship-dev/go-zero/tools/goctl/docker"
	"github.com/dropship-dev/go-zero/tools/goctl/env"
	"github.com/dropship-dev/go-zero/tools/goctl/gateway"
	"github.com/dropship-dev/go-zero/tools/goctl/internal/cobrax"
	"github.com/dropship-dev/go-zero/tools/goctl/internal/version"
	"github.com/dropship-dev/go-zero/tools/goctl/kube"
	"github.com/dropship-dev/go-zero/tools/goctl/migrate"
	"github.com/dropship-dev/go-zero/tools/goctl/model"
	"github.com/dropship-dev/go-zero/tools/goctl/quickstart"
	"github.com/dropship-dev/go-zero/tools/goctl/rpc"
	"github.com/dropship-dev/go-zero/tools/goctl/tpl"
	"github.com/dropship-dev/go-zero/tools/goctl/upgrade"
