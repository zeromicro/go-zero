...
type (
	...
	Collection interface {
		...
		CountDocuments(ctx context.Context, filter interface{}, opts ...*mopt.CountOptions) (
			int64, error)
		...
		Distinct(
			ctx context.Context, fieldName string, filter interface{},
		...
		EstimatedDocumentCount(
			ctx context.Context, opts ...*mopt.EstimatedDocumentCountOptions) (int64, error)
		// Find finds the documents matching the provided filter.
		Find(ctx context.Context, filter interface{}, opts ...*mopt.FindOptions) (
			*mongo.Cursor, error)
		...
		FindOneAndDelete(
			ctx context.Context, filter interface{}, opts ...*mopt.FindOneAndDeleteOptions) (
			*mongo.SingleResult, error)
		...
		FindOneAndReplace(
			ctx context.Context, filter interface{}, replacement interface{},
...
func (c *decoratedCollection) Aggregate(
...
func (c *decoratedCollection) BulkWrite(
...
func (c *decoratedCollection) CountDocuments(
...
func (c *decoratedCollection) DeleteMany(
	ctx context.Context, filter interface{},
...
func (c *decoratedCollection) DeleteOne(
	ctx context.Context, filter interface{},
	opts ...*mopt.DeleteOptions) (res *mongo.DeleteResult, err error) {
...
func (c *decoratedCollection) Distinct(
	ctx context.Context, fieldName string, filter interface{},
...
func (c *decoratedCollection) EstimatedDocumentCount(
	ctx context.Context,
...
func (c *decoratedCollection) Find(
	ctx context.Context, filter interface{},
...
func (c *decoratedCollection) FindOne(
	ctx context.Context, filter interface{},
...
func (c *decoratedCollection) FindOneAndDelete(
	ctx context.Context, filter interface{},
...
func (c *decoratedCollection) FindOneAndUpdate(
	ctx context.Context, filter interface{}, update interface{},
...
func (c *decoratedCollection) InsertMany(
...
func (c *decoratedCollection) InsertOne(
	ctx context.Context, document interface{},
...
func (c *decoratedCollection) ReplaceOne(
	ctx context.Context, filter interface{}, replacement interface{},
...
func (c *decoratedCollection) UpdateByID(
	ctx context.Context, id interface{}, update interface{},
...
func (c *decoratedCollection) UpdateMany(
	ctx context.Context, filter interface{}, update interface{},
	opts ...*mopt.UpdateOptions) (res *mongo.UpdateResult, err error) {
...
func (c *decoratedCollection) UpdateOne(
	ctx context.Context, filter interface{}, update interface{},
	opts ...*mopt.UpdateOptions) (res *mongo.UpdateResult, err error) {
...
func (c *decoratedCollection) logDuration(
	ctx context.Context, method string, startTime time.Duration, err error,
	docs ...interface{}) {
	...
	if e != nil {
		...
		if duration > slowThreshold.Load() {
			logger.Slowf(
				"[MONGO] mongo(%s) - slowcall - %s - fail(%s) - %s",
...
func (c *decoratedCollection) logDurationSimple(
	ctx context.Context, method string, startTime time.Duration, err error) {
